...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFound(ObjectNotFoundException e, HttpServletRequest request) {
		StandardError err = new StandardError(sdf.format(System.currentTimeMillis()), HttpStatus.NOT_FOUND.value(),
	...
	public ResponseEntity<StandardError> dataIntegrity(DataIntegrityException e, HttpServletRequest request) {
		StandardError err = new StandardError(sdf.format(System.currentTimeMillis()), HttpStatus.BAD_REQUEST.value(),
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		ValidationError err = new ValidationError(sdf.format(System.currentTimeMillis()),
	...
	public ResponseEntity<StandardError> authorization(AuthorizationException e, HttpServletRequest request) {
		StandardError err = new StandardError(sdf.format(System.currentTimeMillis()), HttpStatus.FORBIDDEN.value(),
	...
	public ResponseEntity<StandardError> amazonService(AmazonServiceException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(sdf.format(System.currentTimeMillis()), code.value(),
